...
public class InvestmentUpdateDialog extends JDialog {
	...
	private static JComboBox<String> investmentTypeComboBox;

	private static InvestmentItem investmentItemInput;

	private static String CLASS;

	public static void openInvestmentUpdateDialog(
			String amcName,
			String fundName,
			String investedAmount,
			String dateOfInvestment,
			String balancedUnits,
			String averageNav,
			String currentNav,
			String folioNumber,
		...
		try {
			...
			InvestmentUpdateDialog dialog = new InvestmentUpdateDialog();
			dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
			dialog.setVisible(true);
			
			amcNameTextField.setText(amcName);
			fundNameTextField.setText(fundName);
			investedAmountTextField.setText(investedAmount);
			dateOfInvestmentTextField.setText(dateOfInvestment);
			balancedUnitTextField.setText(balancedUnits);
			averageNavTextField.setText(averageNav);
			currentNavTextField.setText(currentNav);
			folioNumberTextField.setText(folioNumber);
			xirrTextField.setText(xirr);
			tenureOfInvestmentTextField.setText(tenure);
			
			investmentTypeComboBox.setSelectedIndex(0);
	...
	public InvestmentUpdateDialog() {
		...
		JButton doneButton = new JButton("Update");
		...
		doneButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (checkAllFields()) {
					...
					InvestmentsDashboard.onUpdateButtonClickFromDialog(investmentItemInput);
				}
			}
		});
